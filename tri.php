...
// echo color("red"," ===========================\n");
// echo color("red","| Kuota Gratis Tri|\n");
// echo color("red","| By : Nathan Prinsley |\n");
// echo "| Time    :".date('[d-m-Y] [H:i:s]')."   |\n";
// echo " ===========================\n\n";

echo "======================================================\n";
echo "|                    Kuota Gratis Tri                |\n";
echo "|               Sekali Tembak Nambah 3 GB            |\n";
echo "|      Pastiin Udah Pernah Nuker Bonstri Ke Kuota    |\n";
echo "|   Kalo Belum Pernah Tuker Dulu Bonstrinya Ke Kuota |\n";
echo "|               By : Nathan Prinsley                 |\n";
echo "======================================================\n\n";


echo "NO HP: ";
// echo color("yellow", "NO HP: ");
// echo color("red"," Masukin Nomer HP : ");
